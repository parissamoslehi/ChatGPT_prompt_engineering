...
def summarize_multiple_product_reviews(reviews):
...
def summarize_with_word_limit(prod_review):
    prompt = f"""
    Your task is to generate a short summary of a product \
    review from an ecommerce site. 
...
def summarize_with_a_focus_on_price_and_value(prod_review):
    prompt = f"""
    Your task is to generate a short summary of a product \
