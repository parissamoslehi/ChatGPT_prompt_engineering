...
def identify_types_of_emotions(review):
    prompt = f"""
...
def extract_product_and_company_name_from_customer_reviews(review):
    prompt = f"""
...
def doing_multiple_tasks_at_once(review):
    prompt = f"""
    Identify the following items from the review text: 
...
def run(lamp_review, story, topic_list):
    review_sentiment(lamp_review)
    identify_types_of_emotions(lamp_review)
...
if __name__ == '__main__':
    ...
    run(lamp_review, story, topic_list)
